...
class App implements ContainerInterface {
    ...
    public function get(string $id) {
        // 🔥 đặc biệt: inject chính container. trường hợp này thường gặp khi $id là của các factory.
        //các factory thường có tham số truyền cho constructor là ContainerInterface
    ...
    public function make(string $class) {
        if ($class === \Psr\Container\ContainerInterface::class
            || $class === self::class
            || $class === static::class) {
            return $this;
        }
