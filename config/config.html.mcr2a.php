<?php
/*config.rpr2a sử dụng trong việc phân quyền
rpr2a meaning route path + role  to action
...
2. route path có thể chứa regex RoutePattern::EXPR_ALL_MODES tại vị trí module và RoutePattern::EXPR_SINGLE_VALUE | RoutePattern::EXPR_INCLUDE_VALUE tại vị trí controller
    nhằm tương thích với file config.rp2fc.php. Thực tế nếu không xác định rõ ràng
 ...
 *  việc chỉ đưa regex vào 2 vị trí module và action cũng là cân nhắc
  ...
  */
/*return [
'[module:compiled-materials|it-documents]/[controller:category|document]' => ['[role:*]'=>'renderPage'],
'pbt-framework/[controller:category|document]' => ['[role:pbt_fwk_user|admin]'=>'renderPage'],
'bud-project/[controller:category|document]' => ['[role:bud_prj_user|admin]'=>'renderPage'],
