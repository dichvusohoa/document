...
class App{
    ...
    public static function newInstance(string $class): object{
        ...
        if (!$ref->isInstantiable()) {
            //ví dụ abstract, interface, có constructor là private
        ...
        foreach ($ctor->getParameters() as $param) {
            ...
            $type = $param->getType();
            //loại tham số không phải là \ReflectionNamedType
            if(!($type instanceof \ReflectionNamedType) || // trường hợp không khai báo kiểu hoặc là ReflectionIntersectionType 
                    $type->isBuiltin()) //kiểu như int, array...
            {
