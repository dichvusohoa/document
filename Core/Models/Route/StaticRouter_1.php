...
class StaticRouter {
    ...
    // $arrTMCAR: cấu trúc gốm các phần từ [strType][strModule(có thể thiếu)][strController][strAction]=>[arrRole]
    ...
    protected function buildTMCARAtRALevel(
       ...
       foreach ($arrPairRA as [$strRole, $strAction]) {
            ...
            if (!in_array($strRole, $arrNode[$strAction], true)) {
                $arrNode[$strAction][] = $strRole;
            }
        }
